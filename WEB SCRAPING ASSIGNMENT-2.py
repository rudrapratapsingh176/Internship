...
driver=webdriver.Chrome(r"C:\Users\rudra\Downloads\chromedriver_win32\chromedriver.exe")
driver.get("https://www.flipkart.com/apple-ipone-11-black-64-gb/product-reviews/itm4e5041ba101fd?pid=MOBFWQ6BXGJCEYNY&lid=LSTMOBFWQ6BXGJCEYNYZXSHRJ&market place=FLIPKART")
...
df=pd.DataFrame({'Rating':ating,'Review_summary':Review_summary,'Full_review':Full_review})
df
